...
const services = [
  {
    id: 1,
    title: "préfinancer votre voyage",
    description:
    ...
    tag: "Court séjour",
    buttonText: "Découvrez comment...",
  },
 
  {
    id: 3,
    title: "Vous cherchez à étudier à l'étranger?",
    description:
    ...
    tag: "Études",
    buttonText: "Explorez les opportunités",
  },
  {
    id: 4,
    title: "Des trucs et astuces pour votre bonne intégration",
    description:
      "Optimisez votre intégration étudiante avec YimmiLine! Du renouvellement de vos documents à l’assurance santé, en passant par le transport, la recherche de jobs et de stages, nous sommes là pour vous!",
    image: "/images/Photo_Alex.jpeg",
    tag: "Intégration étudiant",
    buttonText: "Explorez nos astuces",
  },
  {
    id: 2,
    title: "Trouvez votre logment en toute sécurité",
    description:
      "YIMMILINE est une société financière habilitée à recevoir des fonds du public, en sa qualité de Société.",
    image: "/images/brochure.jpeg",
    tag: "Intégration étudiant",
    buttonText: "Obtenez votre AVI",
  },
  // Cartes supplémentaires
  {
    id: 5,
    title: "Service supplémentaire 1",

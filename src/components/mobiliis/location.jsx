...
export default function LocationCarousel() {
  ...
  // Slides traduits depuis les taxos
  ...
  // Slides finaux (titre/desc traduits + image)
    ...
    <section className="location-section">
      <Container fluid="md" className="location-container">
        ...
        <div className="locationne">
          <Button className="decouvert">
            {t("locationCarousel.allNews")}
          </Button>
        </div>
      </Container>
    </section>
